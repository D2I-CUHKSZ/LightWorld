...
from .runtime import EventFocusRuntime, SimpleMemRuntime, TopologyAwareRuntime, safe_float
...
def get_active_agents_for_round(
    ...
    event_focus_runtime: Optional[EventFocusRuntime] = None,
) -> List[Tuple[int, Any]]:
    ...
    if event_focus_runtime:
        candidates = event_focus_runtime.focus_candidates(
...
async def run_platform_simulation(
    ...
    event_focus_runtime = EventFocusRuntime(
        config=config,
        simulation_dir=simulation_dir,
        platform=spec.name,
        logger=log_info,
    ...
    for round_num in range(total_rounds):
        ...
        active_agents = get_active_agents_for_round(
            ...
            minutes_per_round=minutes_per_round,
            topology_runtime=topology_runtime,
            event_focus_runtime=event_focus_runtime,
        )
